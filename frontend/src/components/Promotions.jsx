    ...
    (async () => {
      ...
      try {
        const params = {
          ...
          saleOnly: true, // Chỉ lấy sản phẩm có salePrice
        };
        ...
        // Lọc sản phẩm có khuyến mãi và tính % discount
        const promotionProducts = (data.items || [])
          .filter(product => {
            const originalPrice = product?.price || 0;
          ...
          .sort((a, b) => b.discountPercent - a.discountPercent) // Sắp xếp theo % discount giảm dần
          .slice(0, 15); // Lấy 15 sản phẩm có discount cao nhất
    ...
    return (
      <section className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-gray-500">Đang tải sản phẩm khuyến mãi...</div>
        </div>
      </section>
    );
  }
